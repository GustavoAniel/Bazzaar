        ...
        return(
            <View>
                <View style={{flexDirection: 'row',  margin: 5}}>
                    <Image source={require("../images/camisahomem.png")} style={{width: 24, height: 24}}/>
                    <Text style={[estilo.texto_grande]}>Masculino</Text>
                </View>
                <ScrollView horizontal={true} >
                    <View style={[carrossel.card_carrossel]}>
                        <Image style={[carrossel.imagem_carrossel]} source={require("../images/modelo5.jpeg")}/>
                        <Text style={[carrossel.texto_descricao]}>Camisa Branca</Text>
                        ...
                        <TouchableOpacity style={[botoes.vermais]} onPress={() => this.setState({modalVisivel: true,nome: 'Camisa',cor: 'Branca',imagem: 4, preco: 60})}>
                            <Text style={[botoes.texto_branco]}>Ver mais</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={[carrossel.card_carrossel]}> 
                        <Image style={[carrossel.imagem_carrossel]} source={require("../images/modelo6.jpeg")} />
                        <Text style={[carrossel.texto_descricao]}>Camisa Preta</Text>
                        <Text style={[carrossel.texto_container]}>
                            <Text style={[carrossel.preco_semDesconto]}>R$100,00</Text>
                            <Text style={[carrossel.preco_comDesconto]}> R$40,00</Text>
                        </Text>
                        <TouchableOpacity style={[botoes.vermais]} onPress={() => this.setState({modalVisivel: true,nome: 'Camisa',cor: 'Preta',imagem: 5, preco: 40})}>
                            <Text style={[botoes.texto_branco]}>Ver mais</Text>
                        </TouchableOpacity>
                    </View>
